...
下のリンクから最新のアプリケーションをダウンロードして使用できます。

[Releases](https://github.com/h1toiui/pdf-snipper-for-ndl/releases)
...
3. `単一ページ` または `左右分割` と、切り抜き枠のアスペクト比を選びます。
